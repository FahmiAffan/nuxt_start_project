...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/devalue/index.js';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/radix3/dist/index.mjs';
import * as vue$1 from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/vue/index.mjs';
import { version, unref } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/it-dept/Documents/Work/perpus-web/fe/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "primevue": {
      ...
      "importPT": {
        "from": "/Users/it-dept/Documents/Work/perpus-web/fe/presets/wind"
      },
      "options": {
        "unstyled": true
      },
...
const serverAssets = [{"baseName":"server","dir":"/Users/it-dept/Documents/Work/perpus-web/fe/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/it-dept/Documents/Work/perpus-web/fe","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/it-dept/Documents/Work/perpus-web/fe/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/it-dept/Documents/Work/perpus-web/fe/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/it-dept/Documents/Work/perpus-web/fe/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/it-dept/Documents/Work/perpus-web/fe/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _ulCTrxRtuF = (function(nitro) {
...
const _J2QwSM6qZE = defineNitroPlugin(async (nitroApp) => {
...
const _M79uMX3YLG = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_nfgrXq = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_nfgrXq, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_nfgrXq, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[{"rel":"stylesheet","href":"https://awesome-lib.css"},{"rel":"stylesheet","href":"https://fonts.cdnfonts.com/css/futura-std-4"}],"style":[],"script":[{"src":"https://awesome-lib.js"}],"noscript":[]};
...
const getClientManifest = () => import('file:///Users/it-dept/Documents/Work/perpus-web/fe/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/it-dept/Documents/Work/perpus-web/fe/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
